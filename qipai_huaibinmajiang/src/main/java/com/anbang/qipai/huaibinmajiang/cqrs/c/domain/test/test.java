...
import com.anbang.qipai.huaibinmajiang.cqrs.c.domain.NoDanpaiQiDuiziGouXingPanHu;
import com.anbang.qipai.huaibinmajiang.cqrs.c.domain.OptionalPlay;
import com.anbang.qipai.huaibinmajiang.cqrs.c.domain.HuaibinMajiangHuPaiSolutionsTipsFilter;
import com.anbang.qipai.huaibinmajiang.init.TableMgr;
...
public class test {
    ...
    public static void main(String[] args) {
        ...
        //optionalPlay.setDaifengpai(true);
        optionalPlay.setHongzhongLaizi(true);
        optionalPlay.setErwubaYingjiang(true);
        optionalPlay.setHuErwubaJiafan(true);
        optionalPlay.setJiangErwubaJiafan(true);
        optionalPlay.setRezhangBuhu(true);
        optionalPlay.setKehuQiduiJiafan(true);
        //optionalPlay.setKehuQiduiBuJiafan(false);
        optionalPlay.setQingyiseJiafan(true);
        //optionalPlay.setZhuangliuXiansi(false);
        optionalPlay.setPaofen(5);
        MajiangPlayer majiangPlayer = new MajiangPlayer();
        majiangPlayer.setMenFeng(MajiangPosition.dong);
        majiangPlayer.addGuipaiType(MajiangPai.hongzhong);
        majiangPlayer.addShoupai(MajiangPai.hongzhong);
        majiangPlayer.addShoupai(MajiangPai.hongzhong);
        majiangPlayer.addShoupai(MajiangPai.hongzhong);
        majiangPlayer.addShoupai(MajiangPai.hongzhong);
        ...
        majiangPlayer.setGangmoShoupai(MajiangPai.wuwan);
        ...
        huaibinMajiangHuPaiSolutionsTipsFilter.hupaiFilter(majiangPlayer,new NoDanpaiQiDuiziGouXingPanHu());
//        HuaibinMajiangJiesuanCalculator.calculateBestZimoHu(new NoDanpaiQiDuiziGouXingPanHu(),majiangPlayer,optionalPlay);
